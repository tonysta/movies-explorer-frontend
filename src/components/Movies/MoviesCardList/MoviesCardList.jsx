...
function MoviesCardList({type, children, errMsg, movies, onAddMovies, hasLoaded, visibleMovies}) {
    ...
    return(
        <section className="movies-list">
            ...
            </div>
            {
                ...
                <button 
                type='button'
                className={visibleMovies >= movies.length || type === "savedMovies" ? 
                "movies-list__button-more_type_hidden":
